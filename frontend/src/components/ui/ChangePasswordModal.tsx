...
export const ChangePasswordModal: React.FC<ChangePasswordModalProps> = ({
  ...
  return createPortal(
    ...
    >
      <div className="bg-surface-2 border border-fg/[0.1] rounded-3xl max-w-md w-full p-6 sm:p-7 space-y-5 shadow-apple-elevated shadow-[inset_0_1px_0_0_rgba(255,255,255,0.08)] relative my-auto max-h-[90vh] overflow-y-auto animate-in zoom-in-95 duration-200">
        <button
          type="button"
          onClick={onClose}
        ...
        {erro && (
          <div className="p-3.5 rounded-xl bg-danger/10 border border-danger/25 text-danger text-xs flex items-center gap-2.5">
        ...
        {sucesso && (
          <div className="p-3.5 rounded-xl bg-success/10 border border-success/25 text-success text-xs flex items-center gap-2.5">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1.5">
            <label className="block text-xs font-medium text-fg/70 tracking-tight">
              Senha Atual
            </label>
            <div className="relative">
              <input
                ...
                placeholder="••••••••••••"
                className="w-full bg-fg/[0.03] border border-fg/[0.1] rounded-xl pl-3.5 pr-11 py-2.5 text-xs sm:text-sm text-fg placeholder-fg/30 focus:outline-none focus:border-fg/30 focus:ring-2 focus:ring-fg/10 transition"
              />
              <button
                type="button"
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              placeholder="••••••••••••"
              className="w-full bg-fg/[0.03] border border-fg/[0.1] rounded-xl px-3.5 py-2.5 text-xs sm:text-sm text-fg placeholder-fg/30 focus:outline-none focus:border-fg/30 focus:ring-2 focus:ring-fg/10 transition"
            />
          </div>
          ...
          <div className="flex items-center justify-end gap-3 pt-3 border-t border-fg/[0.1]">
            <Button
              type="button"
              variant="outline"
              size="sm"
