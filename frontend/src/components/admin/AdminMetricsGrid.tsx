  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
      ...
      <div className="bg-fg/[0.03] border border-fg/[0.06] hover:border-fg/[0.15] p-5 sm:p-6 rounded-2xl space-y-3 transition-all duration-200 group">
        <div className="flex items-center justify-between text-fg/60 text-xs uppercase tracking-wider font-medium">
        ...
        <div>
          ...
          <span className="text-xs text-fg/60 mt-1 block tracking-tight">Faturamento acumulado</span>
        </div>
      </div>
      ...
      <div className="bg-fg/[0.03] border border-fg/[0.06] hover:border-fg/[0.15] p-5 sm:p-6 rounded-2xl space-y-3 transition-all duration-200 group">
        ...
        <div>
          ...
          <span className="text-xs text-fg/60 mt-1 block tracking-tight">Agendamentos no dia</span>
        </div>
      </div>
      ...
      <div className="bg-fg/[0.03] border border-fg/[0.06] hover:border-fg/[0.15] p-5 sm:p-6 rounded-2xl space-y-3 transition-all duration-200 group">
        ...
        <div>
          ...
          <span className="text-xs text-fg/60 mt-1 block tracking-tight">Histórico geral da arena</span>
        </div>
      </div>
      ...
      <div className="bg-fg/[0.03] border border-fg/[0.06] hover:border-fg/[0.15] p-5 sm:p-6 rounded-2xl space-y-3 transition-all duration-200 group">
        ...
        <div>
          <div className="text-2xl sm:text-3xl font-bold text-fg tracking-[-0.03em]">
            ...
            <span className="text-sm font-normal text-fg/60 ml-1.5 font-mono">
              / {metricas.totalQuadras}
            </span>
          </div>
          <span className="text-xs text-fg/60 mt-1 block tracking-tight">Prontas para locação</span>
        </div>
      </div>
    </div>
  );
