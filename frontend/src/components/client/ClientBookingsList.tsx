...
export const ClientBookingsList: React.FC<ClientBookingsListProps> = ({
  ...
  return (
    <div className="bg-fg/[0.03] border border-fg/[0.06] rounded-3xl p-5 sm:p-7 space-y-6">
      ...
      {status === 'error' && agendamentos.length === 0 ? (
        <div className="py-12 px-6 flex flex-col items-center justify-center text-center bg-fg/[0.03] border border-fg/[0.06] rounded-2xl space-y-4">
          ...
          <button
            type="button"
            onClick={reload}
            className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-fg hover:bg-fg/90 text-on-accent font-semibold text-xs transition active:scale-95 cursor-pointer"
          >
