    ...
    public SecurityFilterChain filterChain(
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/agendamentos/agenda", "/agendamentos/agenda/**", "/api/agendamentos/agenda", "/api/agendamentos/agenda/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/agendamentos/dashboard/**", "/api/agendamentos/dashboard/**").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.GET, "/agendamentos/quadra/*/contadores", "/api/agendamentos/quadra/*/contadores").hasRole("ADMIN")
